...
const PersonDetails = () => {
    ...
    return info ? (
        <div className='px-[10%] w-screen h-[170VH] bg-[#1F1E24]'>
            {/* part 1 navigation */}
            <nav className='items-center h-[10vh] w-full text-zinc-100 flex gap-10 text-xl'>
                <Link
                    onClick={() => navigate(-1)}
            ...
            <div className='w-full flex'>
                ...
                <div className='w-[80%] ml-[5%]'>
                    ...
                    <div className='list-disc text-zinc-400 mt-5 w-[full] h-[50vh] overflow-x-hidden overflow-y-auto shadow-xl shadow-[rgba(255,255,255,.3)]
                        border-2 border-zinc-700 p-5'>

                        {info[Category + "Credits"].cast.map((c, i) => (
                            <li key={i} className='hover:text-white p-5 rounded duration-300 cursor-pointer'>
