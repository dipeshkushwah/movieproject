        ...
        >
            ...
            <div className='w-full flex'>
                ...
                <div className='content ml-[5%] text-white'>
                    ...
                    <div className='mt-3 mb-5 flex items-center gap-x-3'>
                        <span
                            className=' rounded-full text-m font-semibold bg-yellow-600 text-white w-[6vh] h-[6vh] 
            ...
            <div className='w-[100%] flex overflow-y-hidden mb-5 p-5'>
                {info.detail.seasons.length > 0 ? info.detail.seasons.map((s, i) => (
                    <div
                        key={i}
                        className='w-[15vh] mr-[10%]'>
                        <img className='shadow-[8px_17px_38px_2px_rgba(0,0,0,.5)] min-w-[14vw] h-[30vh] object-cover'
            ...
            <hr className='mt-10 mb-5 border-none bg-zinc-500 h-[2px]' />
            <h1 className='text-3xl font-bold text-white'>Recomendations & stuff</h1>
            <HorizontalCards
                data=
                {
