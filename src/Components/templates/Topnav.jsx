...
const Topnav = () => {
    ...
    return (
        <div className='w-full h-[10vh] relative flex justify-center items-center '>
            ...
            <div className='z-[100] absolute w-[50%] max-h-[50vh] bg-zinc-200 top-[100%]  overflow-auto rounded'>

                {searches.map((s,i) =>(
                    <Link 
                        to={`/${s.media_type}/details/${s.id}`}
                        key = {i} 
                        className='hover:text-black hover:bg-zinc-300 duration-300 font-semibold h-10 text-zinc-600 w-[100%]  p-10 flex 
